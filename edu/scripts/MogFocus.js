...
(function($){
		...
		return this.each(function(){
			...
			$scroBox.children("li").each(function(i){
				switch(opt.btnStyle){
					...
					case 'noNumber':
						...
						break;
					case 'thumbnail':     
						/*	var thum = $(this).find(".imgBtn").find('img').attr("src","images/clock-face.png")$scroBox.children().children().eq(i).clone().find("img").attr({    */
			...
			function fdivs(i){
				...
				case 0: 
					...
					$(".news3").slideUp(800);
					$(".news4").slideUp(800);
					$(".main-box1").slideUp(1000);
					$(".main-box1").slideDown(1000);
					$(".main-box2").slideUp(1000);
					$(".main-box3").slideUp(1000);
					$(".main-box4").slideUp(1000);
					break;
				case 1:
					$(".news2").css("visibility","visible")
					$(".main-box2").css("visibility","visible")
					$(".pic2").fadeIn(2000);
					$(".pic1").fadeOut();
					$(".pic3").fadeOut();
					$(".pic4").fadeOut();
				...
				case 2:
					...
					$(".main-box3").css("visibility","visible")
				  	$(".pic3").fadeIn(2000);
					$(".pic2").fadeOut();
					$(".pic1").fadeOut();
					$(".pic4").fadeOut();
	...
	$.fn.mogFocus.defaults = {
		...
		thumHeight : 44,  //缩略图高度
		thumlen : 3,  //缩略图显示个数
		thumCSS : {"right":"50%","margin-right":-480},  //提供当全屏滑动时缩略图位置
		thumSubsty : {"border":"2px solid #eeeeee","padding":1,"background":"","filter":"alpha(opacity=50)","-moz-opacity":"0.5" ,"opacity":"0.5"},  //缩略图样式
		thumSelected : {"border":"2px solid #7ccaff","background":"","filter":"alpha(opacity=100)","-moz-opacity":"1" ,"opacity":"1"},  //缩略图选中样式
